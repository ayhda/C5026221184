...
<html lang="en">
  <head>
    ...
    <title>Magic Eden | Twitter, Instagram, TikTok | Linktree</title>
  ...
  <body>
    <div class="container">
      <div id="big-box">
        ...
        <div class="container">
          <img id="head-logo" src="./foto/head-logo.png" />
        </div>
        <div>
          <h1>Magic Eden</h1>
        </div>
        <div>
          <h2>
            Leading multichain NFT platform on Solana, Polygon, Ethereum &
            Bitcoin
          </h2>
        </div>
        <div class="container">
          <a href="https://twitter.com/magiceden" target="_blank"
            ><img class="social-logo hover-logo" src="./foto/twitter-logo.png"
          /></a>
          <a href="https://instagram.com/magicedenofficial" target="_blank"
            ><img
              class="social-logo hover-logo"
              src="./foto/instagram-logo.png"
          /></a>
          <a href="https://www.youtube.com/c/MagicEden" target="_blank"
            ><img class="social-logo hover-logo" src="./foto/youtube-logo.png"
          /></a>
          <a href="https://tiktok.com/@magicedenofficial" target="_blank"
            ><img class="social-logo hover-logo" src="./foto/tiktok-logo.png"
          /></a>
          <a
            href="https://open.spotify.com/episode/1SddTfjYlWwZIUyIJcNcKX?si=DdFyjo78TiqjzDcqK3S6qg"
            target="_blank"
            ><img class="social-logo hover-logo" src="./foto/spotify-logo.png"
          /></a>
        </div>
        <a
          class="tile hover-content"
        ...
        >
          <div>
            <img
              class="icon"
              src="https://ugc.production.linktr.ee/PMlfktNQm6hSOn98K84Q_ME_Logo_Gradient_BG.png"
            />
          </div>
          <p>Magic Eden</p>
        ...
        <a
          class="tile hover-content"
          href="https://bit.ly/3Ki4DTk"
          target="_blank"
        >
          <div>
            <img
              class="icon"
              src="https://ugc.production.linktr.ee/MPIkRarIRUagGoDFIooN_magic_eden_diamond%202.png
            "
            />
          </div>
          <p>Rewards Hub</p>
        ...
        <a
          class="tile hover-content"
          href="http://bit.ly/3JEqYsG"
          target="_blank"
        >
          <div>
            <img
              class="icon"
              src="https://ugc.production.linktr.ee/pA3VmpzFQkuQH63BVfkQ_convert.png"
            />
          </div>
          <p>Magic Eden Games</p>
          <div class="share-button">
            <svg
              style="color: white"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          class="tile hover-content"
          href="http://bit.ly/3Z5sUjG"
          target="_blank"
        >
          <div>
            <img
              class="icon"
              src="https://ugc.production.linktr.ee/Oek3iR0pQaqEUAHe8DO9_meonbtc.jpeg"
            />
          </div>
          <p>Bitcoin Platform</p>
          <div class="share-button">
            <svg
              style="color: white"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          class="tile hover-content"
          href="https://polygon.magiceden.io/?utm_source=magiceden&utm_medium=organic&utm_term=&utm_content=homepage&utm_campaign=product-marketing-marketplace"
          target="_blank"
        >
          <div>
            <img
              class="icon"
              src="https://ugc.production.linktr.ee/uKzOpjWoSvm6fJj8MgcR_meonpolygon.jpeg"
            />
          </div>
          <p>Polygon Platform</p>
          <div class="share-button">
            <svg
              style="color: white"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          class="tile hover-content"
          href="http://blog.magiceden.io/"
          target="_blank"
        >
          <div>
            <img class="icon-blank" />
          </div>
          <p>Blog</p>
          <div class="share-button">
            <svg
        ...
        <a
          class="tile hover-content"
          href="https://cdn.forms-content.sg-form.com/013b5b0a-cc40-11ec-ba89-fe0638626297"
          target="_blank"
        >
          <div>
            <img class="icon-blank" />
        ...
        <a
          class="tile hover-content"
          href="https://creators.magiceden.io/dashboard"
          target="_blank"
        >
          <div>
            <img class="icon-blank" />
          </div>
          <p>Secondary listings application</p>
          <div class="share-button">
            <svg
              style="color: white"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          class="tile hover-content"
          href="https://airtable.com/shrzLz2c3JAyAVorA"
          target="_blank"
        >
          <div>
            <img class="icon-blank" />
          </div>
          <p>Launchpad application</p>
          <div class="share-button">
            <svg
              style="color: white"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <h3>Resources & more</h3>
        <a
          class="tile hover-content"
          href="https://drive.google.com/drive/u/0/folders/1LtIa_VFn7CVtygYKYTKRyIh4q9BwiFLq"
          target="_blank"
        >
          <div>
            <img class="icon-blank" />
          </div>
          <p>Magic Eden logo pack</p>
          <div class="share-button">
            <svg
              style="color: white"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          class="tile hover-content"
          href="https://boards.greenhouse.io/magiceden"
          target="_blank"
        >
          <div>
            <img class="icon-blank" />
        ...
        <a
          href="https://linktr.ee/?utm_source=linktree&utm_medium=profile&utm_content=magiceden"
          target="_blank"
        >
          <div class="linktree-logo-container">
            <svg
              height="100%"
              viewBox="0 0 80 17"
